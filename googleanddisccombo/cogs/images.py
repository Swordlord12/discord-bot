...
disses = ["I listen to a few songs sometimes I suppose.", "Kts obsession in human form.", "Kt will come if u diss."]

mgk = ["https://cdn.discordapp.com/attachments/870304490635542568/870479227311505438/image0.jpg",
        "https://cdn.discordapp.com/attachments/870304490635542568/870479227567370250/image1.jpg",
        "https://cdn.discordapp.com/attachments/870304490635542568/870479227751911485/image2.jpg",
        "https://cdn.discordapp.com/attachments/870304490635542568/870479665586921562/image0.jpg",
        "https://cdn.discordapp.com/attachments/870304490635542568/870479845405110283/image0.jpg"]
...
class Images(commands.Cog, description='Commands that have to do with images, gifs, or tweaking a users profile picture.'):
    ...
    @commands.command(aliases=['ktsobsession', 'mgk', 'trash', 'machinegunkelly'])
    async def kts_obsession(self, ctx):
        """nobody knows why this is"""
        embed = discord.Embed(title="Prohibition Era Gangster From Tenessee", description=random.choice(disses), color=0x000080)
        embed.set_image(url=random.choice(mgk))
        await ctx.send(embed = embed)
